...
public class Paciente
{
    ...
    public async Task AtenderAsync(SemaphoreSlim semaforoDiagnostico, Queue<Paciente> colaDiagnostico)
    {
        Estado = "Consulta";
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        for (int i = 1; i <= 4; i++)
        {
            ...
            tareas.Add(paciente.AtenderAsync(semaforoDiagnostico, colaDiagnostico));
